...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="relative w-full scroll-mt-16 py-20 bg-[#0d1117]">
      <a 
        href="#experience" 
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="relative space-y-12 border-l-2 border-slate-800 pl-8 ml-3">
              ...
              <div className="relative">
                <div className="absolute -left-[41px] top-1 h-5 w-5 rounded-full bg-primary ring-8 ring-[#0d1117]"></div>
                <div>
                  <span className="text-sm font-medium text-slate-400">2020 - Present</span>
                  <h4 className="mt-1 text-lg font-bold text-white">Senior Software Developer, Tech Solutions Inc.</h4>
              ...
              <div className="relative">
                ...
                <div>
                  ...
                  <h4 className="mt-1 text-lg font-bold text-white">Software Developer, Cloud Innovations</h4>
                  <p className="mt-2 text-slate-400 leading-relaxed">
              ...
              <div className="relative">
                ...
                <div>
                  ...
                  <h4 className="mt-1 text-lg font-bold text-white">Junior Developer, Data Corp</h4>
                  <p className="mt-2 text-slate-400 leading-relaxed">
          ...
          <div className="order-1 lg:order-2">
            <div className="rounded-2xl border border-slate-800 bg-card-dark p-8 shadow-xl">
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-slate-300">Scalable Backend Architecture with Python</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CloudUpload className="mt-1 h-5 w-5 text-primary" />
                    <span className="text-slate-300">AWS Cloud Infrastructure & Automation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Code className="mt-1 h-5 w-5 text-primary" />
                    <span className="text-slate-300">CI/CD Pipeline Design & Implementation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Users className="mt-1 h-5 w-5 text-primary" />
                    <span className="text-slate-300">Technical Leadership & Mentorship</span>
                  </li>
                </ul>
              </div>

              <div className="mt-8 border-t border-slate-800 pt-6">
                <button className="w-full rounded-lg bg-primary py-3 text-sm font-bold text-white transition-colors hover:bg-primary/90">
                  Download Resume
                </button>
              </div>
            </div>
